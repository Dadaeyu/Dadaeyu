/**
 * schema-community-events-ui.sql 적용
 * SUPABASE_ACCESS_TOKEN 이 .env.local 에 있으면 Management API로 실행.
 *
 * 사용: node scripts/apply-community-events-ui.mjs
 */
...
const SQL_FILE = "schema-community-events-ui.sql";
