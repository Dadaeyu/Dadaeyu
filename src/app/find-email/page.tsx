  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <div>
          <label className="mb-1 block text-xs font-semibold text-gray-500">휴대폰</label>
          <PhoneField
            value={phone}
            onChange={setPhone}
      ...
      {result && (
        <div className="bg-brand-50 rounded-xl p-4 text-center" role="status">
          <p className="mb-1 text-xs text-gray-500">등록된 이메일</p>
          <p className="text-brand-700 text-lg font-bold">{result}</p>
        </div>
      )}
