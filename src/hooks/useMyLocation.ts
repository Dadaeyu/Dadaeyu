...
export type MyLocationErrorReason = "unsupported" | "denied" | "unavailable" | "timeout" | null;
...
// 권한 거부·조회 실패 시 location은 null로 유지되어 마커를 표시하지 않고, resetTrigger를
// 올려 지도를 대전 전체 화면으로 되돌린다.
