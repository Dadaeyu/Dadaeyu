...
export interface PlaceColor { color: string; bg: string; }
...
export interface Place {
  ...
  colorKey: PlaceColorKey; category: string;
  rating: number; accessibility: string[]; distance: string;
  emoji: string; hot: boolean;
}

export const PLACES: Place[] = [
  { id: 1, name: "대전 엑스포 과학공원", lat: 36.3740, lng: 127.3838, colorKey: "violet", category: "과학", rating: 4.8, accessibility: ["시각", "보행", "청각"], distance: "2.3km", emoji: "🔬", hot: true },
  { id: 2, name: "성심당", lat: 36.3243, lng: 127.4275, colorKey: "red", category: "빵지순례", rating: 4.9, accessibility: ["보행", "고령자"], distance: "1.5km", emoji: "🥐", hot: true },
  { id: 3, name: "한밭수목원", lat: 36.3507, lng: 127.3770, colorKey: "green", category: "자연힐링", rating: 4.7, accessibility: ["시각", "보행", "영유아"], distance: "3.2km", emoji: "🌿", hot: true },
  { id: 4, name: "유성온천", lat: 36.3592, lng: 127.3445, colorKey: "amber", category: "문화예술", rating: 4.5, accessibility: ["보행", "고령자"], distance: "5.1km", emoji: "♨️", hot: false },
  { id: 5, name: "대청호 오백리길", lat: 36.4500, lng: 127.5400, colorKey: "blue", category: "자연힐링", rating: 4.6, accessibility: ["보행"], distance: "12.4km", emoji: "🏞️", hot: true },
];
